...
export class NonbillablehoursComponent implements OnInit {
  ...
  Initialisations() {
    ...
    this.cols = [
      { field: 'ReportGroup', header: 'Report Group', align: 'left', width: '10em' },
      { field: 'EmployeeName', header: 'Employee Name', align: 'left', width: '10em' },
      { field: 'Jan', header: 'JAN', align: 'right', width: '5em' },
      { field: 'Feb', header: 'FEB', align: 'right', width: '5em' },
      { field: 'Mar', header: 'MAR', align: 'right', width: '5em' },
      { field: 'Apr', header: 'APR', align: 'right', width: '5em' },
      { field: 'May', header: 'MAY', align: 'right', width: '5em' },
      { field: 'Jun', header: 'JUN', align: 'right', width: '5em' },
      { field: 'Jul', header: 'JUL', align: 'right', width: '5em' },
      { field: 'Aug', header: 'AUG', align: 'right', width: '5em' },
      { field: 'Sep', header: 'SEP', align: 'right', width: '5em' },
      { field: 'Oct', header: 'OCT', align: 'right', width: '5em' },
      { field: 'Nov', header: 'NOV', align: 'right', width: '5em' },
      { field: 'Dec', header: 'DEC', align: 'right', width: '5em' },
      { field: 'Total', header: 'TOTAL', align: 'right', width: '5em' },
    ];
    this.selectedReportType = 1;
